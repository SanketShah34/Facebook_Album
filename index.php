...
<html>
	...
	<body background="https://sanketwebldrp.000webhostapp.com/facebook/libs/resources/img/home.jpg">
	<!-- Page Loder -->
		<div id="preloader">
			<div id="status">&nbsp;</div>
		</div>
						...
						<div class="card bg-lights">
							...
							<div class="m-t-20 m-b-30">
						    	...
						    	<div class="text-center m-t-40 offset-md-3 col-md-6 offset-sm-3 col-sm-6">
						    		<a id="login-link" class="btn btn-primary btn-lg" href="<?php echo $helper->getLoginUrl( $perm , 'v3.1');?>">Facebook</a>
							    </div>
							</div>
						</div>
					</div>
